...
<main class="shell">
    ...
    <section class="panel guide-panel" style="margin-top: 18px;" data-guide-tabs>
        <div class="guide-topic-list" role="tablist" aria-label="Chief Judge guide topics">
            <button type="button" class="guide-topic-button active" data-guide-target="workflow" role="tab" aria-selected="true">Main Workflow</button>
        ...
        <div class="guide-topic-content">
            <section class="guide-topic-pane active" data-guide-pane="workflow" role="tabpanel">
                <h1>Main Workflow</h1>
            ...
            <section class="guide-topic-pane" data-guide-pane="tools" role="tabpanel" hidden>
                <h1>Helpful Tools</h1>
            ...
            <section class="guide-topic-pane" data-guide-pane="checklist" role="tabpanel" hidden>
                ...
                <div class="actions">
                    <a class="button" href="<?= e(url('departments/election/election-day-checklist.php')) ?>">Precinct Checklist</a>
                </div>
            </section>

            <section class="guide-topic-pane" data-guide-pane="debrief" role="tabpanel" hidden>
            ...
            <section class="guide-topic-pane" data-guide-pane="wrong" role="tabpanel" hidden>
